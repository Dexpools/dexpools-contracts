...
const harmonyAddressesFilepath = path.join(__dirname, '..', '..', `.harmony-temp-addresses-${process.env.HARDHAT_NETWORK}.json`)
...
module.exports = { sendTxn, deployContract, contractAt, writeTmpAddresses, writeTmpAddressesByHarmony, readTmpAddresses, readTmpAddressesByHarmony}
